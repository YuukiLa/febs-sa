...
/**
 * 定时任务配置
 * http://www.quartz-scheduler.org/documentation/quartz-2.3.2/configuration/
 *
 * @author MrBird
 */
@Configuration
...
public class FebsJobConfigure {
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        // 设置数据源
        DataSource job = dynamicRoutingDataSource.getDataSource("primary");
        factory.setDataSource(job);
        Properties prop = new Properties();
        // 任务调度实例名称，集群时多个实例名称保持一致
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "FebsScheduler");
        ...
        factory.setSchedulerName("FebsScheduler");
        // 延时启动
