package cn.yuuki.job.handler;



import cn.yuuki.common.utils.SpringContextUtil;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ThreadPoolTaskExecutor scheduleJobExecutorService = SpringContextUtil.getBean("quartzThreadPool",ThreadPoolTaskExecutor.class);
